...
{
    public class WarehouseIndexActionModel: IControllerActionModel
    {
        public TabName TabName { get; set; } = TabName.Warehouse;
        ...
        public dynamic Execute()
        {
            ...
            //
            var repo = new WarehouseIndexRepository();
            repo.Execute();
        ...
        {
            this.TotalItems = this.Warehouses.Count();

            // Apply Search
            if (this.SearchText != null)
                this.Warehouses = this.ApplySearch(this.Warehouses).Cast<Warehouse>();
            // Pagination
            this.Warehouses = this.Pagination(this.Warehouses).Cast<Warehouse>();
        }
